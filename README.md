...
In Yinet's structural design, the device does not exist independently, it
...
- **Relative independence of device functions**

On the basis that the device can effectively establish a connection relationship, Yinet split the definition of the device.
...
- **Unified management of user resources**

As users and consumers of the network, people should not be trapped in a centralized black box. In the Yinet architecture, users are reserved a great ability to manage device resources and their own data.
